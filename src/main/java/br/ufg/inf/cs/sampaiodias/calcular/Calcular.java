...
/**
 * Programa que ilustra a obtenção do dia da semana para uma data específica.
 *
 */
public final class Calcular {
     ...
     *
     * @param args Argumentos necessários para a validação no Parser.
     */
